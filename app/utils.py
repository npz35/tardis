...
def setup_logging(log_level: str = 'INFO', log_file_path: str = Config.LOG_FILE) -> None:
    ...
    logging.getLogger('pdfminer.converter').setLevel(logging.INFO)
    logging.getLogger('pdfminer.pdffont').setLevel(logging.INFO)
    logging.getLogger('pdfminer.encodingdb').setLevel(logging.INFO)

...
class TestPdfAreaSeparator:
    ...
    @pytest.fixture(scope='class')
    def output_folder(self, tmpdir_factory):
        return tmpdir_factory.mktemp('output')

    def test_create_colored_pdf(self, sample_pdf_path, output_folder):
        '''
    ...
    def test_extract_area_infos_text_block_combination(self, sample_pdf_path, output_folder):
        '''
